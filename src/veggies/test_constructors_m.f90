module veggies_test_constructors_m
    use iso_varying_string, only: varying_string, operator(//), var_str
    use veggies_example_m, only: example_t
    use veggies_generator_m, only: generator_t
    use veggies_input_m, only: input_t
    use veggies_input_test_case_m, only: input_test_case_t
    use veggies_simple_test_case_m, only: simple_test_case_t
    use veggies_simple_test_collection_m, only: simple_test_collection_t
    use veggies_test_case_with_examples_m, only: test_case_with_examples_t
    use veggies_test_case_with_generator_m, only: test_case_with_generator_t
    use veggies_test_collection_with_input_m, only: &
    ...
    use veggies_transforming_test_collection_m, only: &
