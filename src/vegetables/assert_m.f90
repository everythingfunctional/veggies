module vegetables_assert_m
    ...
    use vegetables_assert_equals_double_precision_array_m, only: assert_equals
    use vegetables_assert_equals_double_precision_matrix_m, only: assert_equals
    use vegetables_assert_equals_double_precision_tensor_m, only: assert_equals
    use vegetables_assert_equals_integer_m, only: assert_equals
    use vegetables_assert_equals_integer_array_m, only: assert_equals
    use vegetables_assert_equals_integer_matrix_m, only: assert_equals
    use vegetables_assert_equals_integer_tensor_m, only: assert_equals
    ...
    use vegetables_assert_equals_within_relative_array_m, only: &
            assert_equals_within_relative
    use vegetables_assert_equals_within_relative_matrix_m, only: &
            assert_equals_within_relative
    use vegetables_assert_equals_within_relative_tensor_m, only: &
            assert_equals_within_relative
