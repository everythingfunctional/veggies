...
contains
    ...
    pure function check_exceptional() result(result_)
        ...
        nan_vs_nan = assert_equals_within_relative(nan, nan, tiny(num))
        nan_vs_num = assert_equals_within_relative(nan, num, tiny(num))
        num_vs_nan = assert_equals_within_relative(num, nan, tiny(num))
        inf_vs_inf = assert_equals_within_relative(inf, inf, tiny(num))
        inf_vs_nan = assert_equals_within_relative(inf, nan, tiny(num))
        nan_vs_inf = assert_equals_within_relative(nan, inf, tiny(num))
        inf_vs_num = assert_equals_within_relative(inf, num, tiny(num))
        num_vs_inf = assert_equals_within_relative(num, inf, tiny(num))
        neg_inf_vs_neg_inf = assert_equals_within_relative(neg_inf, neg_inf, tiny(num))
        neg_inf_vs_inf = assert_equals_within_relative(neg_inf, inf, tiny(num))
        inf_vs_neg_inf = assert_equals_within_relative(inf, neg_inf, tiny(num))
        neg_inf_vs_nan = assert_equals_within_relative(neg_inf, nan, tiny(num))
        nan_vs_neg_inf = assert_equals_within_relative(nan, neg_inf, tiny(num))
        neg_inf_vs_num = assert_equals_within_relative(neg_inf, num, tiny(num))
        num_vs_neg_inf = assert_equals_within_relative(num, neg_inf, tiny(num))
