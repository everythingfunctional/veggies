...
contains
    ...
    function checkNumCases(input) result(result_)
    ...
    function checkCollectionTopDescription(input) result(result_)
    ...
    function checkCollectionDescriptions(input) result(result_)
    ...
    function checkSpeed(input) result(result_)
