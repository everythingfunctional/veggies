module assert_equals_within_relative_tensor_test
    ...
    implicit none
    private
    public :: test_assert_eq_within_rel_tens
...
contains
    function test_assert_eq_within_rel_tens() result(tests)
        type(test_item_t) :: tests

        tests = describe( &
                "assert_equals_within_relative for tensors", &
                [ it( &
