module assert_equals_double_precision_array_test
    ...
    implicit none
    private
    public :: test_assert_eq_double_arr
...
contains
    function test_assert_eq_double_arr() result(tests)
        type(test_item_t) :: tests

        tests = describe( &
                "assert_equals with double precision arrays", &
                [ it( &
    ...
    pure function check_fail_for_different_numbers() result(result_)
        ...
        associate(example1 => [1.0d0, 2.0d0], example2 => [3.0d0, 4.0d0])
